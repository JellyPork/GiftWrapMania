...
public class clothing : MonoBehaviour
{
    ...
    private Coroutine coroutine_random_clothing;
    ...
    private IEnumerator start_random_clothing()
    {
        ...
        var skin_color = Random.Range(0, 6);
        ...
        var male_female = Random.Range(0, 2);
        ...
        var hairColor = Random.Range(0, 4); // 0 = dark  1 = brown  2 = blonde
        ...
        if (male_female == 0)
        {
            ...
            if (hair == 0)
            {
                ...
                if (hairColor == 0)
                {
                    ...
                    if (hair_cut == 1) hair_a.GetComponent<Renderer>().materials[0].mainTexture = hair_a_textures[1];
                }
            ...
            if (hair == 2)
            {
                ...
                if (hairColor == 1) hair_e.GetComponent<Renderer>().materials[0].mainTexture = hair_e_textures[1];
                if (hairColor == 2) hair_e.GetComponent<Renderer>().materials[0].mainTexture = hair_e_textures[2];
            }
        }
        ...
        if (male_female == 1)
        {
            ...
            if (hair == 0)
            {
                ...
                if (hairColor == 1) hair_c.GetComponent<Renderer>().materials[0].mainTexture = hair_c_textures[1];
                if (hairColor == 2) hair_c.GetComponent<Renderer>().materials[0].mainTexture = hair_c_textures[2];
            }
            ...
            if (hair == 1)
            {
                ...
                if (hairColor == 1) hair_d.GetComponent<Renderer>().materials[0].mainTexture = hair_d_textures[1];
                if (hairColor == 2) hair_d.GetComponent<Renderer>().materials[0].mainTexture = hair_d_textures[2];
            }
        }
        ...
        if (male_female == 0)
        {
            ...
            if (percent > 50 && percent < 70)
            {
                ...
                if (hairColor == 0) beard_a.GetComponent<Renderer>().materials[0].mainTexture = beard_textures[0];
                if (hairColor == 1) beard_a.GetComponent<Renderer>().materials[0].mainTexture = beard_textures[1];
                if (hairColor == 2) beard_a.GetComponent<Renderer>().materials[0].mainTexture = beard_textures[2];
            }
            ...
            if (percent > 70 && percent < 80)
            {
                ...
                if (hairColor == 0) beard_b.GetComponent<Renderer>().materials[0].mainTexture = beard_textures[0];
                if (hairColor == 1) beard_b.GetComponent<Renderer>().materials[0].mainTexture = beard_textures[1];
                if (hairColor == 2) beard_b.GetComponent<Renderer>().materials[0].mainTexture = beard_textures[2];
            }
            ...
            if (percent > 80 && percent < 90)
            {
                ...
                if (hairColor == 0) beard_c.GetComponent<Renderer>().materials[0].mainTexture = beard_textures[0];
                if (hairColor == 1) beard_c.GetComponent<Renderer>().materials[0].mainTexture = beard_textures[1];
                if (hairColor == 2) beard_c.GetComponent<Renderer>().materials[0].mainTexture = beard_textures[2];
            }
            ...
            if (percent > 90 && percent < 100)
            {
                ...
                if (hairColor == 0) beard_d.GetComponent<Renderer>().materials[0].mainTexture = beard_textures[0];
                if (hairColor == 1) beard_d.GetComponent<Renderer>().materials[0].mainTexture = beard_textures[1];
                if (hairColor == 2) beard_d.GetComponent<Renderer>().materials[0].mainTexture = beard_textures[2];
            }
        }


        // determining complet suits or normal cloth
        var suit_or_cloth = Random.Range(0, 2);
        ...
        if (suit_or_cloth == 0)
        {
            ...
            var which_suit = Random.Range(0, 11);
            ...
            if (which_suit == 0)
            {
                ...
                var which_texture = Random.Range(0, 7);
            ...
            if (which_suit == 8)
            {
                ...
                if (hat)
                {
                    ...
                    security_guard_suit_hat.GetComponent<Renderer>().materials[0].mainTexture =
                        security_guard_suit_texture;
                }
            }
        ...
        if (suit_or_cloth == 1)
        {
            ...
            var shoes = Random.Range(0, 3);

            if (shoes == 0)
            {
                shoes1.SetActive(true);

                var shoes1_texture = Random.Range(0, 8);
            ...
            if (shoes == 1)
            {
                ...
                var shoes2_texture = Random.Range(0, 7);
            ...
            var scarfPercentage = Random.Range(0, 100);

            if (scarfPercentage < 20)
            {
                scarf.SetActive(true);

                var textures = Random.Range(0, 11);

                scarf.GetComponent<Renderer>().materials[0].mainTexture = scarf_textures[textures];
            }

            var which_trouser = Random.Range(0, 2);
            ...
            var upper_cloth = Random.Range(0, 4);
